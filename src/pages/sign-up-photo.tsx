...
const SignUpPhoto = (props: Props) => {
  return (
    <section className="fw-normal sign-up-photo mx-auto pt-lg-227 pb-lg-227 pt-130 pb-50">
              ...
              <div className="mb-20">
                <div className="image-upload text-center">
                  <label htmlFor="avatar">
                    <Image src="/icon/avatar.svg" alt="upload" width={120} height={120} />
                  </label>
                  <input
                    id="avatar"
                    type="file"
